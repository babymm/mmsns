 ...
 * mc_user_log
 */
public class MMSnsCommonUserLogEntity extends PersistentEntity {
    ...
    public MMSnsCommonUserLogEntity() {
        super();
    }

    public MMSnsCommonUserLogEntity(String userLogStatus, String creator, Date createTime, Integer userId, String userName, String ip,
