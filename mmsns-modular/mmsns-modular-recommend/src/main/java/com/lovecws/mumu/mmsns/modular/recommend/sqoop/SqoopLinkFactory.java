package com.lovecws.mumu.mmsns.modular.recommend.sqoop;

import com.lovecws.mumu.mmsns.modular.recommend.sqoop.linkconfig.BaseLinkConfig;
...
public class SqoopLinkFactory {
    ...
    private static final Logger log = Logger.getLogger(SqoopLinkFactory.class);
