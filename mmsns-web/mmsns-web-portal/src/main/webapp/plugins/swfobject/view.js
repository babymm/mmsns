    ...
    addFlash: function (pageno) {
        ...
        for (var p = pageno - 1; p <= pageno + 1; p++) {
            if (p != 0 && jQuery("div#swf_" + p).length > 0) {
                ...
                console.log(readerConfig.flashUrl + pageno + ".swf");
...
(function ($) {
    ...
    for (var i = 1; i <= readerConfig.allPage; i++) {
        pageContainer.append("<div class='outer-page'id='outer_page_" + i + "'><div class='inner-page scrollLoading' id='page_" + i + "'><div id='swf_" + i + "'></div></div></div>");
    }
